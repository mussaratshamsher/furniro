...
<div className='grid-3 slider p-2 lg:p-5 xl:p-2 md:col-span-2 lg:col-span-1 ml-5 md:ml-20 lg:ml-0'>
...
<Slider {...settings}>
      ...
      <Image src={urlFor(designsData.image4).url()} 
               alt={designsData.title} width={2000} 
               height={2000} className='w-60 md:w-[400px]
                lg:w-96 mx-10 md:mx-20 lg:mx-0'/> 
      </div>
